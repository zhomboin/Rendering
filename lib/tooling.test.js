...
assert.equal(siteFooterSource.includes("/feed.xml"), true, "footer should expose the RSS feed entry point");
assert.equal(siteFooterSource.includes("RSS Feed"), true, "footer should render an explicit RSS feed label");
