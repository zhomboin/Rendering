export const enMessages = {
  ...
  "home": {
    ...
    "hero": {
      ...
      "title": "The page keeps loading, and the ideas keep taking shape.",
      "copy": "Rendering...",
      "badges": [
        "Claymorphism cards",
    ...
    "featured": {
      ...
      "copy": "A personal blog living room that glows a little and keeps asking you to read on."
    },
    "latest": {
      "kicker": "Latest Notes",
    ...
    "metrics": {
      "articles": {
        "label": "Articles",
        "detail": "public pieces in the current archive"
      },
      "tags": {
        "label": "Tags",
        "detail": "colorful routes into your writing themes"
      },
      "themes": {
        "label": "Themes",
        "detail": "light by default, dark when you want it",
        "value": "02"
      },
      "progress": {
        "label": "Progress",
        "detail": "real reading progress on article pages",
        "value": "Live"
      }
    }
  },
  "about": {
    ...
    "principles": [
      "Playful homepage and card shells",
      "Calm, stable, readable article body",
      "Real theme switching and reading-progress feedback",
      "Room for a future CMS phase"
    ],
  ...
  "blogArchive": {
    ...
    "heroTitle": "Keep browsing with a little curiosity",
    "heroCopy": "",
