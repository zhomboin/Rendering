...
const articleJsonLd = buildArticleJsonLd(
  {
    slug: "designing-a-terminal-first-blog",
    ...
    tags: ["ui-systems", "design"],
    readingTime: "3 min"
  },
  "en"
);
assert.equal(articleJsonLd["@type"], "BlogPosting", "article structured data should expose a BlogPosting node");
assert.equal(articleJsonLd.url, "https://rendering.me/en/blog/designing-a-terminal-first-blog", "article JSON-LD should point at the localized article canonical URL");
assert.deepEqual(articleJsonLd.keywords, ["ui-systems", "design"], "article JSON-LD should reuse article tags as keywords");

const sitemapEntries = buildSitemapEntries([
  { slug: "designing-a-terminal-first-blog", publishedAt: "2026-03-14" },
  { slug: "redis-sentinel-with-docker", publishedAt: "2026-03-19" }
]);
assert.deepEqual(
  ...
  [
    ...
    "https://rendering.me/en/about",
    "https://rendering.me/blog/designing-a-terminal-first-blog",
    "https://rendering.me/blog/redis-sentinel-with-docker",
    "https://rendering.me/en/blog/designing-a-terminal-first-blog",
    "https://rendering.me/en/blog/redis-sentinel-with-docker"
  ],
...
assert.match(
  ...
  /\/api\/og\?kind=post&locale=en&title=Designing\+a\+Terminal-First\+Blog\+Experience&slug=designing-a-terminal-first-blog&meta=2026-03-14\+%C2%B7\+3\+min$/,
